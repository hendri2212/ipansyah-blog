...
<section class="section">
	<div class="section-header"><h1>Form Post</h1></div>
		<div class="row">
			<div class="col-12">
				<div class="card">
					<div class="card-header">
						<?php if (isset($postId->id_post)) {
						...
						<div class="row">
							<div class="col-12">
								...
								<div class="form-group">
									...
									<textarea name="isi" class="summernote-simple"><?php //echo isset($postId->isi)?$postId->isi:''; ?></textarea>
									<!-- <textarea name="isi" class="form-control"><?php echo isset($postId->isi) ? $postId->isi:''; ?></textarea> -->
								</div>
